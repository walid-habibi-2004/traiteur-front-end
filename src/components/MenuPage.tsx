...
const menus = [
  {
    ...
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264516/tziemsi9mw2wkxhcns7u.jpg",
    tag: "MENU MACHWI",
  },
  {
    id: 2,
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264555/etr7z8cd2erjcmmbmiec.jpg",
  ...
  },
  {
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264660/ymudjhghtzgfvvqvjks9.jpg",
  ...
  },
  {
    ...
    title: "Menu TAjine",
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264718/dxsaocuqaozvhfrh8okd.jpg",
    tag: "MENU TAJINE",
  },
  {
    id: 5,
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264772/vbwvmwck2tg9iphqlqlp.jpg",
  ...
  },
  {
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264811/blru5tsb6v8plpzlotfb.jpg",
  ...
  },
  {
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264852/nxeuoeorfi4qevdcxqsu.jpg",
  ...
  },
  {
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264910/fd0rze7ekhee2oyz753t.jpg",
  ...
  },
  {
    ...
    desc: "Votre mariage, notre passion. Un service sur-mesure, raffiné et inoubliable pour célébrer votre plus beau jour avec goût et style.",
    image: "https://res.cloudinary.com/dbbideahh/image/upload/v1780264955/ey9gj0rztrgrpbr9qsby.jpg",
